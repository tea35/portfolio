...
import { ease, fadeLeft, fadeUp, fadeScale } from "@/lib/motion";
    ...
    >
      ...
      >
        <motion.div
          ...
          animate={{
            x: -(currentIndex * (cardWidth + 16)) + centerOffset - 48,
          }}
        ...
        >
          {works.map((work, i) => (
            <motion.div
              ...
              className={`relative flex-shrink-0 w-[min(80vw,480px)] h-[50vh] rounded-xl border bg-card overflow-hidden cursor-pointer ${
                i === currentIndex
          ...
          >
            <Link
              href="/works"
              className="w-full h-full rounded-xl border border-dashed flex flex-col items-center justify-center gap-3 transition-colors duration-300 group"
              style={{ borderColor: "rgba(168,200,74,0.25)" }}
            >
              <span
                className="text-s tracking-[0.2em] font-mono z-2"
